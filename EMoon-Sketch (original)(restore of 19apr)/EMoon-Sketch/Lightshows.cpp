...
// Matthew and Tony's red square  MAY BE REPLACED


void	a0	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	wipe4	(f, duration, strip, 	0	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}


void a1(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip)
{
    wipe4(f, duration, strip, 0, &redblack100, &redblack100, &red1500, &red0700, &red1500); }
...
void	munge1	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fade2	(f, duration, strip, 	1	, &	cobalt0815	, &	blueblack001	, &	greenblack);}
