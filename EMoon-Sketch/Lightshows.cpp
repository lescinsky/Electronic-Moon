...
{
    fade2(f, duration, strip, 0, &purple8015, &purple8015, &purple8015, &magenta0707, &cyan0077); }
...
void	redrise0	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	wipe4	(f, duration, strip, 	0	, &	redblack100	, &	redblack100	, &	redblack100	, &	red0700	, &	red1500	);}
void	redrise1	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fade4	(f, duration, strip, 	0	, &	redblack100	, &	redblack100	, &	redblack100	, &	red0700	, &	red1500	);}
void	redrise2	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	wash4	(f, duration, strip, 	0	, &	redblack100	, &	redblack100	, &	redblack100	, &	red0700	, &	red0700	);}
void	sparkrise0	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	quadsparklefill	(f, duration, strip, 	0	, &	redblack100	, &	red0700	, &	redblack100	, &	red1500	, &	red0700	);}
void	sparkrise1	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	quadsparklefill	(f, duration, strip, 	0	, &	redblack100	, &	redblack100	, &	red0700	, &	red0700	, &	crimson1508	);}
void	sparkrise2	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	quadsparklefill	(f, duration, strip, 	0	, &	redblack100	, &	red0700	, &	redblack100	, &	red0700	, &	red0700	);}
...
void	sparkrise30	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	quadsparklefill	(f, duration, strip, 	0	, &	red1500	, &	red1500	, &	red0700	, &	red1500	, &	darkorange330	);}
...
void	spiral1_11	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	46	, &	cobalt0815	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
...
void	pumpkin_0	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fade2	(f, duration, strip, 	91	, &	purple8015, &	purple8015	, &	richorange	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_1	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	102	, &	darkgreen030	, &	darkgreen030	, &	emerald080	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_2	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	103	, &	darkgreen030	, &	darkgreen030	, &	emerald080	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_3	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	22	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_4	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	23	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_5	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	32	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_6	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	33	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_7	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	26	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_8	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	27	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_9	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	36	, &	redblack100	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_10	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	37	, &	redblack100	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_11	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	51	, &	redblack100	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_12	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	61	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_13	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	62	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_14	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	63	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_15	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	72	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_16	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	64	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_17	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	54	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_18	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	74	, &	redblack100	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_19	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	65	, &	redblack100	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_20	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	56	, &	redblack100	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_21	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	66	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_22	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	76	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_23	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	67	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_24	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	58	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_25	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	68	, &	redblack100	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_26	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	80	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_27	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	91	, &	black000	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_28	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	401	, &	black000	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_29	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	402	, &	black000	, &	redblack100	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	pumpkin_30	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	403	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_31	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	404	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_32	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	98	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_33	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	89	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_34	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	101	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}
void	pumpkin_35	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	104	, &	black000	, &	redblack100	, &	red1500	, &	red0700	, &	red1500	);}


void	blackspot_0	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	65	, &	black000	, &	brown1	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_1	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	64	, &	black000	, &	black000	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_2	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	44	, &	black000	, &	black000	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_3	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	43	, &	black000	, &	brown1	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_4	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	35	, &	black000	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_5	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	55	, &	black000	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_6	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	45	, &	black000	, &	brown1	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_7	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	56	, &	black000	, &	brown1	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_8	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	46	, &	black000	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_9	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	54	, &	black000	, &	brown1	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_10	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	34	, &	black000	, &	brown1	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_11	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	53	, &	black000	, &	black000	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_12	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	24	, &	black000	, &	black000	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_13	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	25	, &	redblack100	, &	black000	, &	black000	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_14	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	33	, &	redblack100	, &	brown1	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_15	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	36	, &	redblack100	, &	brown1	, &	redblack100	, &	red0700	, &	red1500	);}
void	blackspot_16	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	42	, &	redblack100	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_17	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	47	, &	redblack100	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_18	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	52	, &	redblack100	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_19	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	57	, &	redblack100	, &	black000	, &	black000	, &	red0700	, &	red1500	);}
void	blackspot_20	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	63	, &	redblack100	, &	brown1	, &	redblack100	, &	red0700	, &	red1500	);}
void	blackspot_21	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	specklesq	(f, duration, strip, 	66	, &	redblack100	, &	brown1	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_22	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	74	, &	redblack100	, &	black000	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
void	blackspot_23	(eMoonFrame f, eMoonFrame duration, Adafruit_NeoPixel* strip) {	fillsq	(f, duration, strip, 	75	, &	redblack100	, &	black000	, &	redblack100	, &	darkmagenta303	, &	crimson1508	);}
