...
//    int stepSize = duration / strip->numPixels();
//
//    int i0, i1, i2, i3;
//    int32_t colour;  // i.e. this is set to the neutral colour
//    
...
//    i0 = (f * duration) / strip->numPixels();
//    
//                strip->setPixelColor(i0, C0());
//                strip->setPixelColor(i1, C0());
//                strip->setPixelColor(i2, C0());
//                strip->setPixelColor(i3, C0());
}
